...
namespace IdentityShell.Test
{
    ...
    public class IdentityClientCommandTest : IdentityConfigurationCommandTestBase
    {
        ...
        public void IdentityShell_creates_client()
        {
            ...
            this.PowerShell
                .AddCommand("Set-IdentityClient")
                    ...
                    .AddParameter("IdentityProviderRestrictions", Array("ipr-1", "ipr-2"))
                    ...
                    .AddParameter("AllowedScopes", Array("scope-1", "scope-2"))
                    ...
                    .AddParameter("AllowedCorsOrigins", Array("o1", "o2"))
                    .AddParameter("RequireConsent", true)
                    .AddParameter("AllowedGrantTypes", Array(nameof(GrantType.DeviceFlow), nameof(GrantType.Hybrid)))
                    .AddParameter("RequirePkce", true)
                    .AddParameter("AllowPlainTextPkce", true)
                    .AddParameter("AllowAccessTokensViaBrowser", true)
                    .AddParameter("RedirectUris", Array("redirect-1", "redirect-2"))
                    .AddParameter("PostLogoutRedirectUris", Array("plredirect-1", "plredirect-2"))
        ...
        public void IdentityShell_reads_all_clients()
        {
            ...
            Assert.Equal(Array(GrantType.DeviceFlow, GrantType.Hybrid), resultValue.Property<ICollection<string>>("AllowedGrantTypes"));
            ...
            Assert.Equal(new[] { "redirect-1", "redirect-2" }, resultValue.Property<ICollection<string>>("RedirectUris"));
            Assert.Equal(new[] { "plredirect-1", "plredirect-2" }, resultValue.Property<ICollection<string>>("PostLogoutRedirectUris"));
